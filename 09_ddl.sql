...
/*
   ...
   컬럼1 자료형 [제약조건 | autoincrement] [기본값] [comment],
...
VALUES
(1, 'user01', 'pass01', '홍길동',
 '남', '010-1234-5678', 'hong123@gmail.com'),
(2, 'user02', 'pass02', '유관순',
 '여', '010-777-7777', 'yu77@gmail.com');
...
VALUES
(3, 'user03', 'pass03', '이순신',
 '남', '010-777-7777', 'lee222@gmail.com');
...
VALUES
(3, null, 'pass03', '이순신',
 '남', '010-8888-8888', 'lee222@gmail.com');
...
# - NOT NULL + UNIQUE 특징을 가짐 (중복되지 않는 값이 필수)
...
# Duplicate entry '3-100-2026-06-12 11:32:22' for key 'order_composite_pk.PRIMARY'
...
VALUES
(1, 'user01', 'pass01', '홍길동',
 '남', '010-1234-5678', 'hong123@gmail.com', 10),
(2, 'user02', 'pass02', '유관순',
 '여', '010-777-7777', 'yu77@gmail.com', 20);
